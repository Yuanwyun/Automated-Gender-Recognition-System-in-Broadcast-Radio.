...
Original file is located at
    https://colab.research.google.com/drive/1sepxK6CyEYMr-BPwXA2DIJ4rJ-vkKn0W
"""
...
features = extract_feature('/content/drive/MyDrive/finalyear/speaker_diarization/test.wav', mel=True).reshape(1, -1)
# predict the gender!
...
mypath = '/content/drive/MyDrive/finalyear/speaker_diarization/common_voice_durs'
...
for i in sound_files:
  sound = AudioSegment.from_mp3(f"/content/drive/MyDrive/finalyear/speaker_diarization/common_voice_durs/{i}")
  if prev_sound == '0':
    prev_sound = sound
  else: 
...
combined_sounds.export("/content/drive/MyDrive/finalyear/speaker_diarization/join.mp3", format="mp3")
...
# files                                                                         
src = "/content/drive/MyDrive/finalyear/speaker_diarization/join.mp3"
dst = "/content/drive/MyDrive/finalyear/speaker_diarization/join.wav"
...
# Read the Audiofile
samplerate, data = read('/content/drive/MyDrive/finalyear/speaker_diarization/RTE_1.wav')
print(samplerate)
...
myaudio = AudioSegment.from_file("/content/drive/MyDrive/finalyear/speaker_diarization/RTE_1.wav" , "wav") 
